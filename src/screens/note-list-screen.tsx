...
import MoveNoteSheet, {MoveNoteSheetHandle} from '@/components/move-note-sheet'
...
const NoteListScreen = (props: Props) => {
  const { onSidebarToggle, onNoteSelect } = props
  const refMoveNoteSheet = useRef<MoveNoteSheetHandle>(null)
  const {
